...
public class FaceFilterGLSurfaceView extends GLSurfaceView {
    ...
    public FaceFilterGLSurfaceView(Context context) {
        this(context, null);
    }
    ...
    public void onViewCreated(FaceFilterCameraManager cameraManager, FaceFilterFragment fragment) {
        if (mRenderer == null) {
            mRenderer = new FaceFilterRenderer(this, cameraManager, fragment);
        }
        setEGLContextClientVersion(3);
        // Register onSurfaceCreated listener
        // (note: setRenderer can be called only once in the life-cycle of the GLSurfaceView)
    ...
    public void onPause() {
        ...
        // We have to notify the "render thread" about the coming GL context destruction event.
        ...
        // Confirmation received. JNI GL items are destroyed, so now we can destroy the Java GL context.
        super.onPause();
    }
